...
*Release 0.97.0 · protocol spec v0.97 · rules hash `86773a456ddf0c2b`…`*
...
- Implementation release: `package.json` version `0.97.0`
- Constitution version: SPEC.md header `v0.97` (rules hash binds it)
