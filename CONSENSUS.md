...
*Release 0.98.0 · protocol spec v0.98 · rules hash `971459f9f2739b84`…`*
...
- Implementation release: `package.json` version `0.98.0`
- Constitution version: SPEC.md header `v0.98` (rules hash binds it)
