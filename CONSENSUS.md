...
*Release 0.99.0 · protocol spec v0.99 · rules hash `00e17419d7bdcc13`…`*
...
- Implementation release: `package.json` version `0.99.0`
- Constitution version: SPEC.md header `v0.99` (rules hash binds it)
