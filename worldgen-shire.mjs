...
// ---------------------------------------------------------------------
export const PLANS = {
  // ANCHOR. The capital, and now with WEIGHT in it. The plaza used to be
  // flat stone with a well on it; a fountain you can walk into sits at its
  // heart, the keep is fourteen by ten, and market stalls spill west out of
  // the hall. Two banks still, deliberately at opposite corners.
  anchor: [  // 46x30
    '######################  ######################',
    '#............................................#',
    '#.#########..########.....########..########.#',
  ...
  // MILLBROOK. A STREET, not a square, and no wall at all. You walk
  // THROUGH it on the bridge road, houses shoulder to shoulder either side,
  // the mill at the west end where the water is and the pond hedged below.
  // No bank: Millbrook is a place you pass, and that is a job too.
  millbrook: [  // 36x16
    '                                    ',
    '                                    ',
    '  #########..####.####.####.####..  ',
  ...
  // OXENFORD. An open crossroads market -- no wall, because a market that
  // shuts is not a market. Two ranks of stalls, a market cross, a fountain
  // in the lower square, and the one strong room west of Anchor: this is
  // where you bank if you are out this way, and that makes it worth the walk.
  oxenford: [  // 32x26
    '                                ',
    '              ....              ',
    '  .########.........##########  ',
  ...
  // THORNBURY. A walled MANOR with the village outside its gate -- double
  // wall, a courtyard, a hall and a counting house within, and everyone
  // else strung along the road below. Concentric, not gridded. No bank.
  thornbury: [  // 30x26
    '                              ',
    '                              ',
    '  ..######################..  ',
  ...
  // HOLLYBARROW. A FARM: hedge for a boundary, a great barn where another
  // town would put a bank, an orchard in ranks and two folds with real
  // ground in them. The only shire town that is green rather than grey.
  hollybarrow: [  // 32x24
    '                                ',
    ' """"""""""""""  """""""""""""" ',
    ' ".###########................" ',
